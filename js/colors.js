...
(function(lib){
    ...
    lib.getAverageColor = function( rgbcolors ){
        var sum = {r:0, g:0, b:0};
    ...
    lib.getStyleFromRGB = function( rgbcolor ){
        return "rgb("+rgbcolor.r+","+rgbcolor.g+","+rgbcolor.b+")";
    }

    lib.randomRGBColor = function(){
        return this.HSVtoRGB(Math.random(), 1, 1);
    }

    lib.randomColorStyle = function () {
        return this.getStyleFromRGB(this.randomRGBColor());
    }

    lib.componentToHex = function ( c ) {
        var hex = c.toString(16);
        return hex.length == 1 ? "0" + hex : hex;
    }

    lib.rgbToHex = function( r, g, b ) {
        return "#" + this.componentToHex(r) + this.componentToHex(g) + this.componentToHex(b);
    }

    lib.rgbToHex_fast = function( r, g, b ){
    ...
    lib.hexToRgb_fast = function(hex) {
